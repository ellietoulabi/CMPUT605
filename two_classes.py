...
from globals import subjects, txt_labels_two
...
def main():
    ...
    for subj in subjects:
        ...
        labels = label_encoder.fit_transform(txt_labels_two)

        X, y = load_data(path=path, subject=subj, labels=labels, method=NaN_method)
