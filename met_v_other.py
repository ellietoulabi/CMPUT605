...
def main():
    ...
    NaN_method = "zero"
    log_path = (
        "/home/ellie/Desktop/UAlberta/CMPUT605/Code/CMPUT605/logs/TwoClasses/MVO_"
        + classifier
        + "_"
        + NaN_method
        + ".log"
    ...
    for subj in subjects:
        ...
        X, y_tmp = load_data(path=path, subject=subj, labels=labels, method=NaN_method)
